...
public class SceneMain2 : MonoBehaviour {
	...
	public static SceneMain2 instance = null;              //Static instance of GameManager which allows it to be accessed by any other script.
	void Awake()
	{
	...
	void Start () {
		...
		Tuyauxpris =false;
		subttle = new string[5]; 
		subttle[0] = "Bien, la voie est libre. Tu as eu beaucoup de chance, l’ami. D’ailleurs, ";
		subttle[1] = "quel dommage que tu ne puisses pas admirer le superbe vert grisâtre et glauque du sol miteux.";
		subttle[2] = "En même temps avec tous ces débris partout, difficile de voir quoi que ce soit … Ah mais oui, ça va te poser problème, tout ça !  ";
		subttle[3] = "Alors, entre ça, ça et ça … Comment faire … longe un maximum vers la gauche.  ";
